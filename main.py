...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'jannatyadav270@gmail.com' ")
...
def save_pass():
    path = os.path.join("TrainingImageLabel")
    ...
    if old_password == key:
        if new_password == confirm_password:
            ...
            mess.showerror(title='Error', message='Confirm new password does not match.')
    else:
        mess.showerror(title='Wrong Password', message='Please enter the correct old password.')
